...
(function() {
    ...
    L.FreeDraw.Utilities = {
        ...
        /**
         * Responsible to generating geoJSON object for geo-spatial queries.
         * @author yi du on 11/11/2015
         * @method getMySQLPolygons
         * @param latLngGroups {L.LatLng[]}
         * @return {Object}
         */
        getGEOJSONPolygons: function getGEOJSONPolygons(latLngGroups) {
